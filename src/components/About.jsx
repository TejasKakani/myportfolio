function About() {
    return (
      <div id="about" className="h-screen">
          <h1 className="pt-28 justify-self-center text-4xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">About</h1>
